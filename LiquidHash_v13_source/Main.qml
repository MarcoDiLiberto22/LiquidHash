...
ApplicationWindow {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            NumberAnimation on y { from: 400; to: 100; duration: 7000; loops: Animation.InOutSine }
        }
    }
                ...
                ColumnLayout { Layout.fillWidth: true; spacing: 8
                    ...
                    RowLayout { Layout.fillWidth: true; spacing: 10
                        Rectangle {
                            ...
                            border.color: verifyDropTarget.verifyDropActive ? "#5C6BFF" : (pathField.activeFocus ? "#5C6BFF" : "#2A2A3E"); border.width: 1
